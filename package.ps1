...
$Version = (Get-Item bin\x64\dispsvc.exe).VersionInfo.ProductVersion
...
try
{
	...
	Copy-Item 'bin\x86\RhubarbGeekNzAtYourService.dll' 'base\lib\netstandard2.1\RhubarbGeekNzAtYourService.dll'
